...
public prebanned_check(id) {
	...
	new player_steamid[MAX_AUTHID_LENGTH], player_ip[MAX_IP_WITH_PORT_LENGTH], pquery[1024];
...
public prebanned_check_(failstate, Handle:query, error[], errnum, data[], size) {
	...
	new name[MAX_NAME_LENGTH], player_steamid[MAX_AUTHID_LENGTH];
	get_user_authid(id, player_steamid, charsmax(player_steamid));
...
public check_player(id) {
	new player_steamid[MAX_AUTHID_LENGTH], player_ip[MAX_IP_WITH_PORT_LENGTH];
	get_user_authid(id, player_steamid, charsmax(player_steamid));
	get_user_ip(id, player_ip, charsmax(player_ip), 1);
